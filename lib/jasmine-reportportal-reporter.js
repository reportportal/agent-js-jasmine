...
class ReportportalReporter {
    ...
    getSuiteAttributesBySuite (suite) {
        return this.suiteAttributes && this.suiteAttributes.filter(attr => attr.suite === suite).map(attr => ({
            key: attr.key,
            value: attr.value,
        }));
    }
    ...
    suiteStarted(suite) {
        ...
        if (!(this.suiteAttributes && this.suiteAttributes.length)) {
            this.suiteAttributes = this.additionalCustomParams.attributes;
        }
        ...
        this.additionalCustomParams = {};
        this.suiteAttributes = this.suiteAttributes && this.suiteAttributes.slice(attributes.length);
