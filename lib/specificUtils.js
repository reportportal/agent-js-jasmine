...
const MILLISECOND_IN_MICROSECONDS = 1000;
...
function convertIsoStringToMicroseconds(isoDateStringWithMicroseconds) {
  ...
  return date.getTime() * MILLISECOND_IN_MICROSECONDS + microseconds;
}

function getBeforeHookStartTimeInMicroseconds(itemStartTime) {
  return convertIsoStringToMicroseconds(itemStartTime) - MILLISECOND_IN_MICROSECONDS;
}
...
module.exports = {
  ...
  getBeforeHookStartTimeInMicroseconds,
};
