...
class ReportportalAgent {
    constructor(conf) {
        ...
        this.launchInstance = conf.id ? (this.client.startLaunch({id:conf.id, attributes: conf.attributes, description: conf.description})): (this.client.startLaunch({attributes: conf.attributes, description: conf.description}));
